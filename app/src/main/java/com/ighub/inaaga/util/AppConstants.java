...
public class AppConstants {
    ...
    public static final String FEEDBACK1 = App.getInstance().getResources().getString(R.string.i_lost_an_item);
    public static final String FEEDBACK2 = App.getInstance().getResources().getString(R.string.i_was_incorrectly_charged_cancellation_fee);
    public static final String FEEDBACK3 = App.getInstance().getResources().getString(R.string.i_would_like_a_refund);
    public static final String FEEDBACK4 = App.getInstance().getResources().getString(R.string.my_driver_was_unprofessional);
    public static final String FEEDBACK5 = App.getInstance().getResources().getString(R.string.my_vehicle_wasn_t_what_i_expected);
    public static final String FEEDBACK6 = App.getInstance().getResources().getString(R.string.i_had_an_issue_with_reciept_or_payment);
    ...
    public static String WEB_ERROR_MSG = App.getInstance().getResources().getString(R.string.web_error_msg);
    public static String NO_NETWORK_AVAILABLE = App.getInstance().getResources().getString(R.string.no_network_available);
    ...
    private static final String COUNTRY_LIST = "{\"countries\":[{\"name\":\"Nigeria\",\"dial_code\":\"+234\",\"code\":\"NG\"}]}";
